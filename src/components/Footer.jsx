...
import AlternativeLogo from '../images/Logo2.png'

const Footer = () => {
  return (
    <div className='md:hidden flex flex-col gap-6 pl-12 pt-8 text-white absolute bottom-0 w-full bg-black h-[530px]'>
      <img src={AlternativeLogo} alt="" />
      ...
      <div>
        ...
        <div className='flex border-2 w-2/3 rounded-lg pl-4 py-3 mt-2'>
          <img src={EmailIcon} alt="" />
          <input className='bg-transparent ml-4 text-xl outline-none' placeholder='email address' type="email" name="email" id="email" />
        </div>
        <button className='bg-white text-black font-bold text-xl w-2/3 p-3 rounded-lg mt-4'>subscribe</button>
      </div>
